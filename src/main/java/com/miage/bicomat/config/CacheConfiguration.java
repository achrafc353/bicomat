package com.miage.bicomat.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.miage.bicomat.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.miage.bicomat.repository.UserRepository.USERS_BY_EMAIL_CACHE);
