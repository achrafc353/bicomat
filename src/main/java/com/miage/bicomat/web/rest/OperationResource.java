...
/**
 * REST controller for managing {@link com.miage.bicomat.domain.Operation}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingOperation -> {
                    if (operation.getNumero() != null) {
                        existingOperation.setNumero(operation.getNumero());
                    }
                    ...
                    if (operation.getSigne() != null) {
                        existingOperation.setSigne(operation.getSigne());
                    }
                    if (operation.getType() != null) {
                        existingOperation.setType(operation.getType());
                    }
                    if (operation.getEcheance() != null) {
                        existingOperation.setEcheance(operation.getEcheance());
                    }
