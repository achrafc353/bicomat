...
/**
 * REST controller for managing {@link com.miage.bicomat.domain.Client}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Client> result = clientRepository
            ...
            .map(
                existingClient -> {
                    ...
                    if (client.getAdmel() != null) {
                        existingClient.setAdmel(client.getAdmel());
                    }
                    ...
                    if (client.getAnneeArrivee() != null) {
                        existingClient.setAnneeArrivee(client.getAnneeArrivee());
                    }
                    if (client.getNumContrat() != null) {
                        existingClient.setNumContrat(client.getNumContrat());
                    }
                    if (client.getAgency() != null) {
                        existingClient.setAgency(client.getAgency());
                    }
                    if (client.getNumPortable() != null) {
                        existingClient.setNumPortable(client.getNumPortable());
                    }
